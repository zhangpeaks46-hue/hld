...
CREATE TABLE `task_books` (
    ...
    `degree` VARCHAR(20) NULL DEFAULT NULL COMMENT '学历层次',
    `advisor` VARCHAR(50) NULL DEFAULT NULL COMMENT '指导教师',
    `school` VARCHAR(100) NULL DEFAULT NULL COMMENT '学校',
    `word_count` VARCHAR(20) NULL DEFAULT NULL COMMENT '预计字数',
    `ai_provider` VARCHAR(50) NULL DEFAULT NULL COMMENT 'AI提供商标识',
    `ai_model` VARCHAR(100) NULL DEFAULT NULL COMMENT '模型名',
    `result_json` MEDIUMTEXT NULL COMMENT 'AI生成的完整结果JSON',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='毕业设计任务书表';